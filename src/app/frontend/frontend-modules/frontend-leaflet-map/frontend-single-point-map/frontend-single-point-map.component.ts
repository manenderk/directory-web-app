...
@Component({
  selector: 'app-frontend-single-point-map',
  templateUrl: './frontend-single-point-map.component.html',
  styleUrls: ['./frontend-single-point-map.component.css']
})
export class FrontendSinglePointMapComponent implements OnInit {
